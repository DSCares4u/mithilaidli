        ...
        <section class="mt-12">
            <div class="grid gap-8 md:grid-cols-2 lg:grid-cols-3">
                <div class="bg-white p-6 rounded-lg shadow-lg">
                    <img src="/logo/kitchen.jpg" alt="Founders" class="h-48 w-full object-cover rounded-lg">
                ...
                <div class="bg-white p-6 rounded-lg shadow-lg">
                    <img src="/logo/idli-story.jpg" alt="Traditional Recipes" class="h-48 w-full object-cover rounded-lg">
                ...
                <div class="bg-white p-6 rounded-lg shadow-lg">
                    <img src="/logo/ingre.jpg" alt="Fresh Ingredients" class="h-48 w-full object-cover rounded-lg">
                ...
                <div class="bg-white p-6 rounded-lg shadow-lg">
                    <img src="/logo/comm.jpg" alt="Community" class="h-48 w-full object-cover rounded-lg">
                ...
                <div class="bg-white p-6 rounded-lg shadow-lg">
                    <img src="/logo/inno.jpg" alt="Innovation" class="h-48 w-full object-cover rounded-lg">
                ...
                <div class="bg-white p-6 rounded-lg shadow-lg">
                    <img src="/logo/fut.jpg" alt="Our Future" class="h-48 w-full object-cover rounded-lg">
